...
void Menu::setTextFieldsHeadlines()
{
	...
	int currHeadLine = 0;
	setHeadLine(currHeadLine++, "Choose game format", 0, 0);
	m_headLines[gameFormat].setPosition(10, 150);
	setHeadLine(currHeadLine++, "Choose game background", 0, 0);
	setHeadLine(currHeadLine++, "Choose number of players", 0, 0);
	setHeadLine(currHeadLine++, "Choose game color", 0, 0);
	setHeadLine(currHeadLine++, "Enter group name", 0, 0);
}
...
void Menu::setHeadLine(const int index, std::string headLine, float x, float y)
{
